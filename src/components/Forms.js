        ...
        <div className="forms">
            ...
            <div className="form__check-option">
                <div className="form__check-option--in">
                    ...
                    <input className = "form__input input-default" type="text" id="location" name="location" placeholder="mm/dd/yyyy" ></input>
                </div>
            ...
            <div className="form__guests">
                ...
                <input className = "form__input input-default" type="text" id="location" name="location" placeholder="Guests" ></input>
            </div>
